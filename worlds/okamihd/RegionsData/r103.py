...
events = {
    RegionNames.CURSED_HANA_VALLEY:{
        ...
        "Hana Valley - Grow Guardian Sapling": EventData(required_brush_techniques=[BrushTechniques.SUNRISE],required_items_events=["Hana Valley - Defeat Sleepy"],precollected=lambda o:o.BloomGuardianSaplings),
    },
