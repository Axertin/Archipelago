...
brush_techniques_items = {
    ...
    BrushTechniques.GALESTROM.value: ItemData(0x106, ItemClassification.progression),               # bit 6
    ...
    BrushTechniques.WATERSPROUT.value: ItemData(0x10D, ItemClassification.progression),             # bit 13
